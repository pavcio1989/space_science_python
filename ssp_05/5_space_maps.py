...
# Save the figure
plt.savefig('../_images/empty_aitoff.png', dpi=300)
...
# Save the figure
plt.savefig('../_images/eclipj2000_sky_map.png', dpi=300)
...
eclip_plane_df.loc[:, 'j2000_direction'] = (
    eclip_plane_df['ECLIPJ2000_direction']
    .apply(lambda x: ECL2EQU_MAT.dot(x))
)
...
# Save the figure
plt.savefig('../_images/j2000_sky_map.png', dpi=300)
