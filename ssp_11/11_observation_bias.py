...
# Save the figure
plt.savefig('../_images/ssp_11/comets_abs_mag_hist.png', dpi=300)
...
# Save the figure
plt.savefig('../_images/ssp_11/comets_abs_mag_cumul_hist.png', dpi=300)
...
plt.savefig('../_images/ssp_11/comets_abs_mag_log10cumul_hist.png', dpi=300)
...
# Save the figure
plt.savefig('../_images/ssp_11/comets_abs_mag_log10cumul_hist_linreg.png', dpi=300)
...
# Save the figure
plt.savefig('../_images/ssp_11/comets_abs_mag_vs_perih.png', dpi=300)
