...
comet_67p_df.loc[:, 'APHELION_AU'] = \
    comet_67p_df.apply(lambda x: x['SEMI_MAJOR_AXIS_AU']* (1.0 + x['ECCENTRICITY']),
                       axis=1)

print(comet_67p_df.head(5))
...
for col_name, ylabel_name in zip(['PERIHELION_AU',
    ...
    plt.savefig(f'../_images/ssp_13/67P_{col_name}.png', dpi=300)
