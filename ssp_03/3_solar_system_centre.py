...
plt.savefig('../_images/SSB2SUN_DISTANCE.png', dpi=300)
...
for planets_name_key in NAIF_ID_DICT:
    ...
    SOLAR_SYSTEM_DF.loc[:, planet_angle_col] = \
        SOLAR_SYSTEM_DF.apply(lambda x: np.degrees(spiceypy.vsep(x[planet_pos_col], x['POS_SSB_WRT_SUN']))
                              , axis=1
                              )
...
plt.savefig('../_images/PLANETS_SUN_SSB_PHASE_ANGLE.png', dpi=300)
