...
DL_PATH = 'data/'
DL_URL = 'https://naif.jpl.nasa.gov/pub/naif/ROSETTA/kernels/dsk/ROS_CG_M001_OSPCLPS_N_V1.OBJ'
...
# third and fourth column list the coordinates (vertex) and vertex indices (faces)
COMET_67P_SHAPE_OBJ = pd.read_csv(
    'data/ROS_CG_M001_OSPCLPS_N_V1.OBJ',
    sep=r"\s+",
    names=['TYPE', 'X1', 'X2', 'X3']
)
